    ...
    ActionComponent.prototype.release = function () {
        if (this.action.running$.value)
            if (this.parameters.interuptParameters)
                (_a = this.kerviService.spine).sendCommand.apply(_a, [this.action.interuptCommand].concat(this.parameters.interuptParameters));
            else
